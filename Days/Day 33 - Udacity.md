# [10/13/2023, 18:20-20:20]
- **Today's Progress**: Intro to the document object model.
- **Thoughts:** Module starts w/ an overview of the various conventional updates to the lang like Let/Const. intro to my love, template literals. Intro to [[for...Of]] and [[for...in]] loops. Intro to the [[Bey's Cosmic Canopy/Rei's Library/Javascript/JavaScript-React-F.C.C/Basic Data Structures/Basic Data Structures(Arrays)/Spread Operator|Spread Operator]] and the #RestParameter. Intro to #VariadicFunctions. 
---
```
