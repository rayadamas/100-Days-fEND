# [10/9/2023, 12:43-15:29]
- **Today's Progress**: continuing w/ array quizzes. intro'ing array loops and the forEach loop X.X [[forEach]], [[map()]], nested arrays
- **Thoughts:** i've got a good flow of how to display understanding of at least SOME of the methods without being egregious.  
---
```
// Arrays
