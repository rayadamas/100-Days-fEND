# [10/7/2023, 16:41-17:35, 18:01-19:00]
- **Today's Progress**: Continuing function lessons. Function Expressions/Declarations. Anon functions. 
- **Thoughts:** the introducing of function declarations/expressions seems misplaced given someone's likely novice taking to the concepts of programming, like this is essentially shorthand. only once more of a foundation is established would i think it'd make more sense to THEN detail how to "save time" w/ concepts like this. i felt the same w/ essentially shorthand #CSS_property's. damn parenthesis is irritating in making inline functions. 
---
```
// Laught it off
/*
